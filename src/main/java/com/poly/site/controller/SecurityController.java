...
public class SecurityController {
	...
	public String success(OAuth2AuthenticationToken oauth2) {
		...
		return "redirect:/layout/show";
		  ...
		  @RequestMapping("account/profile/{usename}")
		  public String information(Model model, @PathVariable("username") String username) {
		  model.addAttribute("account", dao.findByUsername(username));
